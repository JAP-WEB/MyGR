...
def create_index(book_id, html):
    ...
    palabras = str(soup.p).lower() #obtiene el contenido de <p></p> y lo convierte a minúsculas
    ...
    for clave in claves:
        ...
        r.sadd(clave,book_id) #agrega el identificador y añade la claves al índice de mapeo
